"""
Анализатор качества входного кадра — этап перед слоем 2.

Метрики резкости, шума, контраста → ``quality_score`` и флаги
needs_denoise / needs_contrast_boost / needs_sharpen для адаптивной предобработки.
"""
